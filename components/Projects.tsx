...
export default function Projects() {
  return (
    <div className="relative snap-center w-full min-h-screen">
      <Spotlight
      ...
      <div className="min-h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.075] bg-grid-black-100/[0.075]
